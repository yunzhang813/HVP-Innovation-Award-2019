...
The work is funded by the Human Vaccines Project (HVP). Reanalysis of data from ImmPort studies is partially supported by NIAID UH2AI132342. Data and metadata of the HVP01 vaccination study used in the analytics were provided by HVP and Kollmann group of University of British Columbia. Brian Aevermann of Scheuermann group at JCVI provided the single cell RNA-seq data analysis results from the HVP01 study for validating the cell type specific marker genes identified in our data analysis.
